  ...
  return (
    <>
      ...
      <main className="bg-gray-50">
        ...
        <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white overflow-hidden -mt-[92px] pt-[92px]">
          ...
          <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 text-center">
            <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
              ...
              {/* Key Investment Metrics - Mobile Optimized */}
        ...
        {/* Location & Neighborhood - Mobile Optimized */}
        ...
        {/* Market Comparables - Mobile Optimized */}
        <section className="py-12 sm:py-20 bg-white">
          <div className="max-w-6xl mx-auto px-4 sm:px-6">
            ...
            <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
              <div>
                <h3 className="text-xl sm:text-2xl font-bold mb-4 sm:mb-6 text-gray-900">Comparable Neighborhoods</h3>
                <div className="space-y-3 sm:space-y-4">
                  <div className="flex items-center justify-between p-3 sm:p-4 bg-gray-50 rounded-lg">
                    <span className="font-medium text-sm sm:text-base">Platt Park / Old South Pearl</span>
                    <span className="text-yellow-600 font-semibold text-sm sm:text-base">Our Location</span>
                  </div>
                  <div className="flex items-center justify-between p-3 sm:p-4 bg-gray-50 rounded-lg">
                    <span className="font-medium text-sm sm:text-base">LoHi (Highlands)</span>
                    <span className="text-gray-600 text-sm sm:text-base">Premium Comparable</span>
                  </div>
                  <div className="flex items-center justify-between p-3 sm:p-4 bg-gray-50 rounded-lg">
                    <span className="font-medium text-sm sm:text-base">Cherry Creek</span>
                    <span className="text-gray-600 text-sm sm:text-base">Luxury Benchmark</span>
                  </div>
                  <div className="flex items-center justify-between p-3 sm:p-4 bg-gray-50 rounded-lg">
                    <span className="font-medium text-sm sm:text-base">Union Station</span>
                    <span className="text-gray-600 text-sm sm:text-base">Urban Core</span>
                  </div>
                  <div className="flex items-center justify-between p-3 sm:p-4 bg-gray-50 rounded-lg">
                    <span className="font-medium text-sm sm:text-base">Downtown Denver</span>
                    <span className="text-gray-600 text-sm sm:text-base">Central Business District</span>
                  </div>
                </div>
              </div>
              
              <div className="bg-gray-50 p-6 sm:p-8 rounded-xl">
                <h4 className="text-lg sm:text-xl font-bold mb-4 sm:mb-6 text-gray-900">Competitive Advantages</h4>
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    <div className="w-2 h-2 bg-yellow-600 rounded-full mt-2 flex-shrink-0"></div>
                    <div>
                      <div className="font-semibold text-sm sm:text-base">Historic Character</div>
                      <div className="text-gray-600 text-xs sm:text-sm">Established 1893 neighborhood with authentic charm</div>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    <div className="w-2 h-2 bg-yellow-600 rounded-full mt-2 flex-shrink-0"></div>
                    <div>
                      <div className="font-semibold text-sm sm:text-base">Walkable Lifestyle</div>
                      <div className="text-gray-600 text-xs sm:text-sm">Tree-lined blocks with unique local businesses</div>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    <div className="w-2 h-2 bg-yellow-600 rounded-full mt-2 flex-shrink-0"></div>
                    <div>
                      <div className="font-semibold text-sm sm:text-base">Community Events</div>
                      <div className="text-gray-600 text-xs sm:text-sm">Farmers Market and year-round neighborhood gatherings</div>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    <div className="w-2 h-2 bg-yellow-600 rounded-full mt-2 flex-shrink-0"></div>
                    <div>
                      <div className="font-semibold text-sm sm:text-base">Strategic Location</div>
                      <div className="text-gray-600 text-xs sm:text-sm">Central access to Washington Park, DU, and downtown</div>
                    </div>
                  </div>
                </div>
              </div>
        ...
        {/* Neighborhood Deep Dive - Mobile Optimized */}
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6">
            ...
            <div className="grid lg:grid-cols-3 gap-6 sm:gap-8 mb-8 sm:mb-12">
              <div className="bg-white p-6 sm:p-8 rounded-xl border border-gray-200">
                <h3 className="text-xl sm:text-2xl font-bold mb-4 text-gray-900">Neighborhood Life</h3>
              ...
              <div className="bg-white p-6 sm:p-8 rounded-xl border border-gray-200">
                <h3 className="text-xl sm:text-2xl font-bold mb-4 text-gray-900">Community Events</h3>
                <p className="text-gray-600 leading-relaxed text-sm sm:text-base">
              ...
              <div className="bg-white p-6 sm:p-8 rounded-xl border border-gray-200">
                <h3 className="text-xl sm:text-2xl font-bold mb-4 text-gray-900">History</h3>
                <p className="text-gray-600 leading-relaxed text-sm sm:text-base">
        ...
        <section id="financials" className="py-12 sm:py-20 bg-white">
          <div className="max-w-6xl mx-auto px-4 sm:px-6">
            <div className="text-center mb-12 sm:mb-16">
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 sm:mb-6 text-gray-900">
                Investment Overview
