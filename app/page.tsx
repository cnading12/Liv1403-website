...
const HERO_IMAGES = [
  { src: '/images/hero.png', alt: 'Liv1403 Luxury Development Exterior' },
    ...
    <main className="bg-gray-50">
      ...
      <section id="value" className="py-12 sm:py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          {/* Feature Image */}
          <div className="relative h-96 sm:h-[500px] rounded-2xl overflow-hidden mb-12 shadow-2xl">
            <Image 
              src="/images/old.jpg" 
          ...
          <div className="bg-gradient-to-br from-gray-50 to-white rounded-3xl overflow-hidden shadow-2xl border border-gray-200">
            ...
            <div className="grid lg:grid-cols-5 gap-8 sm:gap-12 p-8 sm:p-12">
              ...
              <div className="lg:col-span-2">
                <div className="relative h-96 lg:h-full min-h-[400px] rounded-2xl overflow-hidden bg-gray-200 shadow-xl sticky top-8">
                  <div className="absolute inset-0 flex flex-col items-center justify-center text-gray-500 p-8 text-center">
                    ...
                    <p className="text-sm">Lance Nading Professional Photo</p>
                  </div>
                </div>
              </div>
